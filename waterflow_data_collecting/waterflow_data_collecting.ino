...
void loop () {
  ...
  Serial.print (units); //Prints the number calculated above
  Serial.print (" Units\r\n");
  backupData.b_water = units;

  //Check total unit use
  //every 1000 total unit = 1 irl unit
  Serial.print("Total useage = ");
  Serial.print(floor(units / 1000));
  Serial.print("\n");
  total = floor(units / 1000);
  backupData.b_total = total;
